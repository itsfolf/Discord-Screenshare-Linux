...
typedef struct VAAPIEncodeType {
    ...
    int (*get_encoder_caps)(void *avctx);

    // Perform any extra codec-specific configuration after the
    // codec context is initialised (set up the private data and
    // add any necessary global parameters).
    int (*configure)(void *avctx);
    ...
    int  (*init_sequence_params)(void *avctx);
    int   (*init_picture_params)(void *avctx,
                                 VAAPIEncodePicture *pic);
    int     (*init_slice_params)(void *avctx,
                                 VAAPIEncodePicture *pic,
    ...
    int (*write_sequence_header)(void *avctx,
                                 char *data, size_t *data_len);
    int  (*write_picture_header)(void *avctx,
                                 VAAPIEncodePicture *pic,
                                 char *data, size_t *data_len);
    int    (*write_slice_header)(void *avctx,
                                 VAAPIEncodePicture *pic,
                                 VAAPIEncodeSlice *slice,
                                 char *data, size_t *data_len);
    ...
    // returned.
    int    (*write_extra_buffer)(void *avctx,
                                 VAAPIEncodePicture *pic,
                                 int index, int *type,
                                 char *data, size_t *data_len);
    ...
    // with increasing index argument until AVERROR_EOF is
    // returned.
    int    (*write_extra_header)(void *avctx,
                                 VAAPIEncodePicture *pic,
                                 int index, int *type,
                                 char *data, size_t *data_len);
} VAAPIEncodeType;
...
int ff_vaapi_encode_receive_packet(void *avctx, void *pkt);

int ff_vaapi_encode_init(void *avctx);
int ff_vaapi_encode_close(void *avctx);
